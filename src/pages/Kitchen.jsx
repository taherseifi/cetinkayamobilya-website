  ...
  return (
    <section className="w-full bg-gray-100 py-16 mt-10">
      ...
      >
        ...
        <h1 className="relative z-10 tracking-widest uppercase">mutfak</h1>
      </div>
      ...
      <div className="text-center max-w-4xl mx-auto pt-10">
        ...
        Mutfaklarınıza Şıklık ve İşlevsellik Katın!
        </h2>

        <p className="mt-6 text-gray-600 leading-8">
         Çetinkaya Mobilya olarak, mutfaklarınızı estetik ve kullanışlı tasarımlarla buluşturuyoruz. Modern, klasik ve özel tasarım mutfak dolaplarıyla alanınızı en verimli şekilde değerlendiriyoruz. Kaliteli malzemeler ve özenli işçilikle üretilen mutfaklarımız, hem dayanıklı hem de şık bir kullanım sunar.
        </p>

        <p className="mt-4 text-gray-600">
          Hayalinizdeki mutfağa kavuşmak için bizimle iletişime geçin!
        </p>
